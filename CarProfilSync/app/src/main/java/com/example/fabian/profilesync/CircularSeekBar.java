...
public class CircularSeekBar extends View {
    ...
    // Default values
    private static final float DEFAULT_CIRCLE_X_RADIUS = 20f;
    private static final float DEFAULT_CIRCLE_Y_RADIUS = 10f;
    ...
    private static final int DEFAULT_CIRCLE_COLOR = Color.LTGRAY;
    private static final int DEFAULT_CIRCLE_PROGRESS_COLOR = Color.RED;
    private static final int DEFAULT_POINTER_COLOR = Color.argb(235, 255, 0, 0);
    private static final int DEFAULT_POINTER_HALO_COLOR = Color.argb(135, 255, 0, 0);
    private static final int DEFAULT_POINTER_HALO_COLOR_ONTOUCH = Color.argb(135, 255, 0, 0);
